...
def launch_setup(context, *args, **kwargs):
    ...
    cropbox_parameters["min_x"] = vehicle_info["min_longitudinal_offset"]-0.4
    cropbox_parameters["max_x"] = vehicle_info["max_longitudinal_offset"]-1.2
